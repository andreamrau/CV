...
\begin{cventries}
    ...
    \cventry{INRAE Commission scientifique spécialisée (CSS) Mathématiques, Informatique, Scienes et Technologies du numérique, Intelligence artificielle et Robotique (MISTI}{Appointed member}{2021-2024}{}{}\vspace{-4.0mm}
    \cventry{Saclay Plant Sciences Research Open Call}{Reviewer}{2021}{}{}\vspace{-4.0mm}
    \cventry{INRAE GABI Scientific Communication and Mediation committee}{Member}{2021}{}{}\vspace{-4.0mm}
...
\item PI: Giorgia Egidy-Maskos; Role: Co-investigator
\end{cvitems}}
...
\end{cvitems}}
    \cventry{CDD (6 months)}{Maxime Guilleton}{2021}{}{\begin{cvitems}
...
\item Constructing predictive models for ovine production data (with Eli Sellem, [Allice](http://www.allice.fr/))
\end{cvitems}}
...
\item Statistical analysis of RNA-seq data
\end{cvitems}}
    \cventry{Instructor (with M.-L. Martin-Magniette and E. Delannoy) @ INRAE, BioEcoAgro}{Researcher training session: From gene expression to genomic networks (17-22 July)}{2019}{}{\begin{cvitems}
