...
#  titles.left.cex = c(4, 2, 1),
  ...
  timeline = data.frame(title = c("St. Olaf College", "Purdue University", "Purdue University", "Inria", "INRA", "UWM", "UWM",
                                  "Mayo Clinic", "Walgreens", "Ensai", "Medical College\nof Wisconsin"),
                        ...
                        start = c(2001.75, 2005.75, 2007.75, 2010.75, 2011.75, 2016.58, 2017.83, 2005, 2006.4, 2012.3, 2019),
                        end = c(2005.42, 2007.74, 2010.67, 2011.75, 2021, 2016.75, 2019.5, 2005.15, 2006.7, 2017.3, 2020.5),
  ...
  interests = list("R" = c(rep("coseq", 4), "HTSCluster", rep("HTSFilter", 3), rep("EDGE in TCGA", 2)),
                   "statistics" = c(rep("mixture models", 6), rep("clustering", 3), rep("networks", 5), rep("Bayesian", 3)),
                   "genomics" = c(rep("multi-omics", 8), rep("ATAC-seq", 2),  rep("co-expression", 6), rep("networks", 3))),
  year.steps = 1
)
